...
description: An upsolve writeup for a blockchain CTF challenge
...
After hours of searching for solutions (and of course, asking my AI Assistant, which wasn’t very helpful that time), I finally stumbled upon this article about a **Second Preimage Attack on Merkle Trees**:
